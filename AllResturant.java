...
public class AllResturant extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AllResturant frame = new AllResturant();
	...
	public AllResturant() {
		...
		panel_1.setBounds(0, 99, 644, 332);
		...
		JLabel lblNewLabel_3 = new JLabel("Dhal");
		...
		JLabel lblNewLabel_3_1 = new JLabel("Rice");
		...
		JLabel lblNewLabel_3_1_1 = new JLabel("Fish");
